  ...
  return (
    <>
      ...
      <div className="title-header">
        {/* <h1>List of Teacher Logs</h1> */}
        <p>View the info of all Teacher Logs in the library </p>
      </div>
      ...
      <div className="table-container">
        <h2>Teacher</h2>
        <div className='export-container' onClick={handleExport} style={{left: '110px', top: '15px'}}>
