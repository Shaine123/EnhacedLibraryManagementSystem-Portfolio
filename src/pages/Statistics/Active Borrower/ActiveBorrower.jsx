 ...
 console.log(bookInfo)
  return (
    <>
       ...
       <h1>List of Most Active Borrower</h1>
      ...
      <div className="title-header">
        {/* <h1>List of Most Active Borrower</h1> */}
        <p>View the list of the most active borrower</p>
      </div>
      ...
      <h2>Most Active Borrower</h2>
       <StatMostLoggedTable data = {bookInfo} month = {month}/>
      </div>
    </>
  )
}
