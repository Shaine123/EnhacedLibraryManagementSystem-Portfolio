...
import GuestTable from '../../../layout/table/GuestTable'
import GuestAdd from '../../../components/ModalUI/GuestAdd'
import GuestEdit from '../../../components/ModalUI/GuestEdit'
...
const Guest = () => {
 ...
 useEffect(()=>{
  ...
  axios.get('http://localhost:3002/getGuest')
 .then(res => {
     setData(res.data)
 })
  ...
  return (
    <>
      ...
      <div className="title-header">
        {/* <h1>List of Guest</h1> */}
        <p>View the info of all registered guest </p>
      </div>
      ...
      <div className="filter-container">
        ...
        <button class="button-52" role="button"  onClick={()=>{handleClick()}}>ADD GUESS</button>
      </div>
      ...
      { isRegistering ?  <GuestAdd/> : ''}
      { isEditing ? <GuestEdit data = {result} id = {identifier}/> : '' }
      { openQR ? <QRModal data = {result} type = {'guest'}/> : ''}
