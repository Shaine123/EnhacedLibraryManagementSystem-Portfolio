...
import { deleteGuest, deleteStudent } from '../../state/MongoDB/MongoDBSLice';
...
const GuestTable = ({header,search, data, onEdit, createQR,selectAll, perPage}) => {
                ...
                <tr  
                  ...
                  <td style={{display: 'flex', alignItems: 'center', gap: '10px', marginTop: '10px'}}>
                   ...
                   <button className="action-btn" onClick={()=>{handleAction(item._id)}}>  
                    ...
                    {
                         item._id == action ?
                         <div className="action-container" style={{marginRight: '40px'}}>
                           <ul>
                              <li onClick={()=>{
                                 dispatch(generateQR())
                                 createQR(item._id)
                              ...
                              <li onClick = {()=>{
                                 dispatch(deleteGuest({id : item._id}))
                                 dispatch(changeData())
                              }}>
                               <img src={Delete} alt="" />
                                  <p>Delete</p>
